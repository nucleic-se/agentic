...
export function defaultAgentExtensions(options: DefaultAgentOptions): Extension[] {
    ...
    return [
        ...
        { id: options.planning ? 'loop.planning' : 'loop.conversational', version: '1.0.0', apiVersion: 1, roles: { loop: () => options.planning ? planningLoop() : conversationalLoop() } },
        ...
        { id: 'tools.coding', configuration: options.workspace, version: '1.0.0', apiVersion: 1, roles: { tools: () => codingToolRuntime(options.workspace) } },
